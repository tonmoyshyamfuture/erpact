<style>
    .row-height{height: 54px; overflow:hidden;}
</style>
<div style="" class="wrapper2">
    <div class="side_toggle">
        <div  id="myDiv"><button class="btn btn-sm btn-danger myButton  btn-closePanel"><i class="fa fa-times"></i></button>
            <form class="" style="padding:20px;">
                ...
                <div class="form-group">
                    <input type="number" name="no_of_print" id="no_of_print" class="form-control onlyNumeric" placeholder="Number of print" value="1" min="1" max="5">
                </div>
            </form>
        </div>
    </div>
    ...
    <section class="content-header">
        <div class="row">
            <div class="col-xs-6">
                <h1><i class="fa fa-shopping-cart" aria-hidden="true"></i><?php echo isset($voucher['type']) ? $voucher['type'] : '' ?></h1>
            </div>
            <div class="col-xs-6">
                    ...
                    <div class="btn-group btn-svg">
                        ...
                        if ($permission):
                            ?>
                                ...
                                <!-- <a class="btn btn-default" href="<?php echo base_url('transaction/entry-delete') . "/" . $entry->id . "/" . $entry_type_id; ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" > <i class="fa fa-trash"></i></a> -->
                            ...
                            if ($entry_type_id == 5):
                                ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/sales-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i data-feather="edit"></i></a>
                                <?php if(!isset($ewaybillDetails->entry_id) && isset($despatchDetails->motor_vehicle_no) && $despatchDetails->motor_vehicle_no != ''){ ?>
                                    <button class="btn btn-default ladda-button eway-bill-pdf" data-color="blue" data-style="slide-right" entry-id="<?php echo $entry->id; ?>" id="eway-bill-download-pdf" data-toggle="tooltip" data-placement="bottom" title="Eway Bill Generate"><i class="fa fa-truck"></i></button>
                                <?php } ?>
                                <?php if(isset($despatchDetails->motor_vehicle_no) && isset($ewaybillDetails->motor_vehicle_no) && ($despatchDetails->motor_vehicle_no != $ewaybillDetails->motor_vehicle_no)){ ?>
                                    <button class="btn btn-default " entry-id="<?php echo $entry->id; ?>" id="eway-bill-update-vehicle" data-toggle="tooltip" data-placement="bottom" title="Update vehicle No"><i class="fa fa-truck"></i></button>
                                <?php } ?>
                                 <?php if(isset($ewaybillDetails->entry_id) && isset($ewaybillDetails->cancel_status) && $ewaybillDetails->cancel_status == 0){ ?>
                                     <button class="btn btn-default " data-color="red" data-style="slide-right" entry-id="<?php echo $entry->id; ?>" id="eway-bill-canceled" data-toggle="tooltip" data-placement="bottom" title="Cick to cencel ewaybill">C</button>
                                 <?php } ?>
                            <?php elseif ($entry_type_id == 6): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/purchase-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i data-feather="edit"></i></a>
                            <?php elseif ($entry_type_id == 144): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/credit-note-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i class="fa fa-fa-truckpencil"></i></a>
                            <?php elseif ($entry_type_id == 122): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/debit-note-update') . "/" . $entry->id . "/" . $$entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i data-feather="edit"></i></a>
                            <?php elseif ($entry_type_id == 7): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/sales-order-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i data-feather="edit"></i></a>
                                <?php // if (isset($entry['order_status']) && ($entry['order_status'] == 'Open' || $entry['order_status'] == 'Partial')): ?>
                                <?php if (isset($entry->order_status) && ($entry->order_status == 'Open' || $entry->order_status == 'Partial')): ?>
                                    <a class="btn btn-default" href="<?php echo site_url('transaction/sales-order-sales') . "/" . $entry->id . "/" . $entry_type_id . "/t"; ?>" data-toggle="tooltip" data-placement="bottom" title="Sales" > <i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                                <?php endif; ?>
                            <?php elseif ($entry_type_id == 8): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/purchase-order-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i data-feather="edit"></i></a>
                                <?php if (isset($entry->order_status) && ($entry->order_status == 'Open' || $entry->order_status == 'Partial')): ?>
                                    <?php // if (isset($entry['order_status']) && ($entry['order_status'] == 'Open' || $entry['order_status'] == 'Partial')):  ?>
                                    <a class="btn btn-default" href="<?php echo site_url('transaction/purchase-order-purchase') . "/" . $entry->id . "/" . $entry_type_id . "/t"; ?>" data-toggle="tooltip" data-placement="bottom" title="Purchase" > <i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                                <?php endif; ?>
                            <?php elseif ($entry_type_id == 9): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/receive-note-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i class="fa fa-pencil"></i></a>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/receive-note-purchase') . "/" . $entry->id . "/" . $entry_type_id . "/t"; ?>" data-toggle="tooltip" data-placement="bottom" title="Purchase" > <i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                            <?php elseif ($entry_type_id == 10): ?>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/delivery-note-update') . "/" . $entry->id . "/" . $entry_type_id . "/e"; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" > <i class="fa fa-pencil"></i></a>
                                <a class="btn btn-default" href="<?php echo site_url('transaction/delivery-note-sales') . "/" . $entry->id . "/" . $entry_type_id . "/t"; ?>" data-toggle="tooltip" data-placement="bottom" title="Sales" > <i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                                <?php
                            endif;
                            ?>
                        <?php endif ?>
                        <button class="btn btn-default save-pdf" data-pdf="dpf_content"><i data-feather="mail"></i></button>
                        <button class="btn btn-default download-invoice-pdf"><i data-feather="printer"></i></button>
                    </div>
                    <button id="button" class="myButton btn btn-primary btn-sm"><i class="fa fa-gear"></i></button>
                </div>
            </div>
        </div>
    </section>
    <section>
        ...
        $current_breadcrumbs = array('Invoice' => '/transaction/invoice');
    ...
    <section class="content" id="invoiceTaxInCol">
        <div class="clearfix bill-wrapper">
            ...
            for ($j = 0; $j < $ceil_data; $j++) {
                ...
                <div class="box">   
                    <div class="box-body pdf_type_1 pdf_class" id="printreport" data-pdf="<?php echo $entry->entry_no; ?>">
                                                    ...
                                                    for ($k; $k < $kk; $k++) {
                                                        if ($k >= $total_data) {
                                                            ...
                                                            <tr class="row-height">
                                                                ...
                                                                <td class="inv-itemdtls"><?php echo isset($row->name) ? $row->name : ''; ?><span class="product-description"><?php echo (strlen($row->product_description) > 80 ) ? substr($row->product_description, 0, 80) . '...' : $row->product_description; ?></span></td>
    ...
    <section class="content hidden" id="invoiceTaxInRow">
        <div class="clearfix bill-wrapper">
            ...
            for ($j = 0; $j < $ceil_data; $j++) {
                ...
                <div class="box">   
                    <div class="box-body pdf_type_2" id="printreport" data-pdf="<?php echo $entry->entry_no; ?>">
        ...
        <div class="modal-content">
            <form action="<?php echo site_url('transaction_inventory/inventory/ajax_delete_transaction'); ?>" method="post" id="delete-transaction-form">
                <div class="modal-header" style="background: #4b83ee;color: #fff">
                    ...
                    <input type="hidden" value="current" id="delete-entry-type" name="delete_entry_type">
    ...
    $(function() {
        ...
        */
        ...
        $('.download-invoice-pdf').click(function() {
            ...
            var no_of_print = $('#no_of_print').val();
            $.ajax({
                url : "<?php echo base_url(); ?>transaction_inventory/inventory/saveInoicePdf",
                type: "POST",
                data : {
                    content     : htmlContent,
                    pdf_name    : pdf_name,
