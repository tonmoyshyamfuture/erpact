...
<style type="text/css">
    ...
    .form-control.product-quantity{height: 31px !important; width:50px; min-height: 31px; padding-left: 5px;}
    .search_product {
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-7 text-right">
                                                            <div class="pull-right">
                                                                <button type="button" class="myButton btn btn-sm btn-primary"><i class="fa fa-gear"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </section>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                if ($action === 't' && ($entry_type == 7 || $entry_type == 8 || $parent_id == 7 || $parent_id == 8)) {
                                                                    ...
                                                                    <div class="col-md-3"><input class="form-control" name="voucher_date" id="voucher_date" placeholder="Ref. Date" value="<?php echo isset($entry->create_date) ? date("d/m/Y", strtotime($entry->create_date)) : ''; ?>"></div> 
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    ...
                                                                    <div class="col-md-3"><input class="form-control" name="voucher_date" id="voucher_date" placeholder="<?php echo ($entry_type==6 || $parent_id==6)?'Supplier Invoice Date':'Ref. Date'?>" value="<?php echo isset($entry->voucher_date) ? date("d/m/Y", strtotime($entry->voucher_date)) : ''; ?>"></div> 
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
                                                                    ...
                                                                    <table class="table table-addorder">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="width-75 text-center">Rate(<i class="fa fa-inr"></i>)</th>
                                                                                <th style="display:none" class="width-150 text-right">Total(<i class="fa fa-inr"></i>)</th>
                                                                                <th style="<?php echo ($displayFlag)?'':'display:none'; ?>" class="width-110 text-right">Gross Total(<i class="fa fa-inr"></i>)</th>
                                                                                <th style="<?php echo ($displayFlag)?'':'display:none'; ?>" class="width-90">Tax(%)</th>
                                                                                <th style="<?php echo ($displayFlag)?'':'display:none'; ?>" class="width-110 text-right">Tax Value(<i class="fa fa-inr"></i>)</th>

                                                                                <th class="width-120 text-right">Total(<i class="fa fa-inr"></i>)</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody class="product-listing-table">
                                                                            ...
                                                                            if (isset($order_details) && count($order_details) > 0):
                                                                                foreach ($order_details as $row) {
                                                                                    ...
                                                                                    <tr class="each-product">
                                                                                        ...
                                                                                        <td><input type="text" class="form-control text-right product-quantity" name="product_quantity[]"  value="<?php echo isset($row->quantity) ? $row->quantity : '1' ?>"/><input type="hidden" class="max-product-qty" value="<?php echo isset($row->quantity) ? $row->quantity : '1' ?>"></td>
                                                                                        <td  style="width: 100px;"><input type="text" class="form-control product-unit text-center" readonly="readonly" name="product_unit[]" value="<?php echo isset($row->unit_name) ? $row->unit_name : '' ?>"/><input type="hidden" class="product-unit-hidden-id" name="product_unit_hidden_id"></td>
                                                                            ...
                                                                            <tr class="product-search-row">
                                                                                ...
                                                                                <td height="40" colspan="10" style="padding: 2px !important">
                                                                            ...
                                                                            <tr class="sub-total" style="border-bottom: 1px solid #e5e5e5; background: #f1f1f1;">                                                                                <td></td>     
                                                                                ...
                                                                                <td class="text-right" id="product_total_gross" ><?php echo $gross_total_product_val; ?></td>
                                                                                <td colspan="2" style="padding-top:0 !important; padding-bottom: 0 !important "><input type="text" name="tax_value" id="tax_value" class="form-control text-right" readonly="readonly" value="<?php echo $total_tax_val; ?>" style="height:35px !important"/></td>
                                                                                <td style="padding-top:0 !important; padding-bottom: 0 !important "><input type="text" name="product_grand_total" id="product_grand_total" class="form-control text-right" readonly="readonly" value="<?php echo $grand_product_val; ?>"  style="height:35px !important"/></td>
                                                                            </tr>                               
                                                                        </tbody>
                                                                    </table>
                                                                </div>
...
<!--                                                                                                <input type="text" class="form-control discount_allowed_input"  style="text-align: right;" value="<?php echo (isset($entry_details[$i]->balance) && $entry_details[$i]->discount_type == 1) ? $entry_details[$i]->discount_amount . '%' : ((isset($entry_details[$i]->balance) && $entry_details[$i]->discount_type == 0) ? $entry_details[$i]->balance : '0.00') ?>"/>
                                                                            ...
                                                                            <tr class="discounts-tr">
                                                                                ...
                                                                                <td style="border: 0 !important; width:150px;  padding-right: 0 !important">
                                                                                    <input type="text" class="form-control discount_allowed_input" style="text-align: right;" value="0.00" disabled="disabled"/>
                                                                ...
                                                                <div class="col-md-10 text-right" style="margin-top: 8px;font-size: 16px; font-weight: bold;">
                                                                    Total (<i class="fa fa-inr"></i>)
                                                                </div>

                                                                <div class="col-md-2">
                                                                    <input type="text" name="netTotal" id="netTotal" class="form-control text-right" readonly="readonly" value="<?php echo ($netTotal) ?>" style="height:35px !important; border: 1px solid #c6d6db !important;background: #eee !important;"/>
                                                                </div>
