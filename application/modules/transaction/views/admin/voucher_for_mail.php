            ...
            <div class="col-md-12">              
                <div class="box">   
                    <div class="box-body pdf_class" id="printreport" data-pdf="Transaction Details<?php echo isset($entry[0]['type'])?'-'.$entry[0]['type']:"" ?>">
                        ...
                        <table class="table vtable" style="display:none!important">
                            <tbody>
                                <tr> 
                                    <td>Particulars</td>
                                    <td class="width-voucher-dr-cr text-right">Debit</td>
                                    <td class="width-voucher-dr-cr text-right">Credit</td>
                                </tr>        
                                ...
                                if (isset($entry_details)) {
                                    for ($i = 0; $i < count($entry_details); $i++) {
                                        ?>
                                <tr>
                                            <td style="text-align: left !important; position: relative;" class="print-border-b-0">
                                                <div class="particulars">
                                                    <div class="particulars_cr"><span><?php echo $entry_details[$i]['account']; ?>.</span> <?php echo $entry_details[$i]['ladger_name']; ?></div>
                                                    <div class="particulars_name">
                                                        <?php if (count($entry_details[$i]['against_ref']) > 0) { ?>
                                            ...
                                            <td class="text-right print-border-b-0"><?php echo ($entry_details[$i]['account'] == 'Dr') ? $this->price_format($entry_details[$i]['balance']) : ""; ?></td>
                                            <td class="text-right print-border-b-0" ><?php echo ($entry_details[$i]['account'] == 'Cr') ? $this->price_format($entry_details[$i]['balance']) : ""; ?></td>              
                                ...
                                ?>                            
                                 <tr>
                                    <td style="text-align: left !important;"  class="print-border-b-0">
                                        <p style="margin:60px 0 0 ">
                                        <?php
                                        if ($entry_details) {
                                            echo '<strong>Narration : </strong>';
                                            echo $entry_details[0]['narration'];                                            
                                            }
                                            ?>
                                            </p>
                                    ...
                                    <td class="print-border-b-0 print-border-lr-1">&nbsp;</td>
                                    <td class="print-border-b-0">&nbsp;</td>
                                </tr>       
                                <tr>
                                    <td style="text-align: left !important;"  class="print-border-b-0">
                                        <p style="margin:0">
                                            Amount (in words) : <i><?php echo ucwords($amountInWord) . ' Only'; ?></i>
                                        </p>
                                    </td>
                                    <td class="print-border-b-0 print-border-lr-1">&nbsp;</td>
                                    <td class="print-border-b-0">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="text-right bold border-tb"></td>
                                    <td class="text-right bold border-tb"><?php echo $this->price_format($entry[0]['dr_amount']); ?></td>
                                    <td  class="text-right bold border-tb"><?php echo $this->price_format($entry[0]['cr_amount']); ?></td>               
                                </tr>
                                
                                <tr id="voucher-footer">
                                    <td colspan="3" style="border:0 !important">                                        
                                        <div style="margin-top:50px; padding: 0 15px">
                                            <div class="row">
                                                <div class="col-xs-4"><strong>Checked by</strong></div>
                                                <div class="col-xs-4 text-center"><strong>Verified by</strong></div>
                                                <div class="col-xs-4 text-right"><strong>Authorized Signatory</strong></div>
                                            </div>
                                        </div>
                    ...
                    <p style="font-size: 10px;">**Amount is displayed in your base currency <b>INR</b></p>
                </div>
            </div><!--/.col (right) -->
        </div>   <!-- /.row -->
    </section><!-- /.content -->
