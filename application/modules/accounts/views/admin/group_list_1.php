    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-xs-6"> 
                ...
                if ($permission):
                    ?>
                    <input type="button" class="btn btn-primary btn-group  <?php echo ((isset($_GET['_tb']) && $_GET['_tb'] == '1') || (!isset($_GET['_tb']))) ? '' : 'hidden' ?>" value="Add Group" onclick="window.location.href = '<?php echo site_url('admin/add-accounts-groups'); ?>'" />
                     <input type="button" class="btn btn-info btn-ledger  <?php echo (isset($_GET['_tb']) && $_GET['_tb'] == '2') ? "" : 'hidden' ?>" value="Add Ledger" onclick="window.location.href = '<?php echo site_url('admin/add-accounts-ledger'); ?>'" />   
            ...
            <div class="col-md-8">
                <div class="accounttabs clearfix">
                    <ul class="nav nav-tabs">
                        <li class="<?php echo (isset($_GET['_tb']) && $_GET['_tb'] == '1') ? 'active' : (!isset($_GET['_tb'])) ? 'active' : '' ?>"><a id="tabgroup" href="#group" data-toggle="tab"> Groups </a></li>
                        <li class="<?php echo (isset($_GET['_tb']) && $_GET['_tb'] == '2') ? 'active' : '' ?>"><a id="tabledger" href="#ledger" data-toggle="tab"> Ledger</a></li>
                    </ul>
                    
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane <?php echo (isset($_GET['_tb']) && $_GET['_tb'] == '1') ? 'active in' : (!isset($_GET['_tb'])) ? 'active in' : '' ?>" id="group">                    
                            <div class="col-md-12">
                                <div class="row">            
                                    <div id="sample_1_wrapper" class="xx">
                                        <div class="box-body table-fullwidth">
                                            <div class="table-scrollable" style="overflow-x: hidden;">

                                                <table class="table table-striped  lcol-70" id="groupListTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Group Name</th>
                        ...
                        <div class="tab-pane <?php echo (isset($_GET['_tb']) && $_GET['_tb'] == '2') ? 'active in' : '' ?>" id="ledger">                
                            <div class="col-md-12">                                                        
                                <div class="row">         
                                    <div class="box-body table-fullwidth">
                                        <div class="">                                    
                                            <div class="table-responsive">
                                                <table class="table table-striped lcol-70" id="ledgerListTable">
                                                    <thead>
                                                        <tr>												
                                                            <th>Ledger Name</th>
                                                            <th>Parent Name</th>
                                                            <th class="width-70 text-center">No of <br> Vouchers</th>
                                    ...
                                    <div class="box-footer">
                                        <div class="footer-button">
                                            ...
                                            if ($permission):
                                                ?>
                                                <input type="button" class="btn btn-primary btn-ledger" value="Add Ledger" onclick="window.location.href = '<?php echo site_url('admin/add-accounts-ledger'); ?>'" />   
                                                <?php
                                            endif;
                                            ?>
                                        </div>
...
<style>    
    ...
    .box-body a.white {color:#fff !important}
</style>
