...
.indent-1.bold, .indent-2.bold, .indent-3.bold, .indent-4.bold {background: #ffffff;color: #000;}
</style>
<?php
...
<div class="wrapper2"> 
        ...
        <div id="myDiv"><button class="btn btn-sm btn-danger myButton  btn-closePanel"><i class="fa fa-times"></i></button>
            <form style="padding:20px;">
                ...
                <div class="form-group">
                    ...
                    <!--<a href="<?php echo base_url('admin/vertical-profit-loss'); ?>">Vertical</a><br>-->
    ...
    <section class="content-header">
        <div class="row">
            <div class="col-xs-6">
                <h1> <i class="fa fa-retweet"></i> Profit And Loss </h1>  
            </div>
            <div class="col-xs-6">
                <div class="pull-right">                    
                    <div class="btn-group btn-svg">
                        ...
                        <button class="btn btn-default save-pdf" data-pdf="profit_loss_vertical"><i data-feather="mail"></i></button>
     ...
     <section>
        ...
        $breadcrumbs=array(
            ...
            'Profit And Loss'=>'/admin/vertical-profit-loss',
        );
...
//                $total_credit_balance = 0;
              ...
              ?>
              <div class="box">                
                  <div class="box-body pdf_class" id="printreport" data-pdf="Profit and Loss">  
                      <div class="table-responsive"> 
                      <table class="table table-pl-vertical table-report nomargin">
                          <thead>
                              <tr>
                                  <th colspan="3">
                                        ...
                                        foreach ($trial_balance_arr as $trial_balance) { ?>
                                            ...
                                            <td>
                                                ...
                                                <?php }elseif($trial_balance['type'] == 'group'){ ?>
                                                    ...
                                                    ?>
                                                    <a href="<?php echo (isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING']!='')?site_url('admin/accounts-trial-balance') .$url_params:site_url('admin/accounts-trial-balance') . "?id=" . $trial_balance['id']; ?>"><?php echo (isset($exp_id_array) && in_array($trial_balance['id'], $exp_id_array))?'<i>Less:</i>':''?> &nbsp;<?php echo $trial_balance['name']; ?></a>
                                                <?php }elseif($trial_balance['type'] == 'stock'){ ?>
                                                    <a href="javascript:void(0);"><?php echo (isset($exp_id_array) && in_array($trial_balance['id'], $exp_id_array))?'<i>Less:</i>':''?> &nbsp;<?php echo $trial_balance['name']; ?></a>
                                                <?php }else{
                                            ...
                                            <td class="width-130">
                                                <?php
                                                    if($trial_balance['level'] != 'level_first' && ($trial_balance['type'] == 'group' || $trial_balance['type'] == 'ledger'  || $trial_balance['type'] == 'stock')){
...
<!--<script>
    $(function () {
        ...
        $('.pldaterange').daterangepicker({
            ...
            var loadUrl = "<?php echo isset($_GET['id'])?site_url('accounts/reports/profit_loss_vertical').'?id='.$_GET['id']:site_url('accounts/reports/profit_loss_vertical'); ?>";
