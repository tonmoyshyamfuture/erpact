<div class="wrapper2">  
    ...
    <section class="content-header">
          <div class="row">
                <div class="col-xs-6">
                    <h1> <i class="fa fa-list"></i> Recurring Entry</h1>  
                </div>
                <div class="col-xs-6">
...
<div id="deleteEntryConfirm" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <form action="<?php echo site_url('accounts/entries/ajax_delete_recurring_entry'); ?>" method="post" id="delete-recurring-entry-form">
