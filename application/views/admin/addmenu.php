...
<section class="content-header">
    <div class="row">
        <div class="col-xs-6">
            <h1> <i class="fa fa-bars"></i> Admin Menu</h1>
        </div>
        <div class="col-xs-6">
                ...
                <div class="box-body">
                  <form role="form" action="<?php echo $this->config->item('base_url');?>admin/addMenu" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="m_parent" id="m_parent">
                    ...
                    <div class="form-group">
                      <label>Label</label>
                      <input type="text" class="form-control" name="m_name" value="" placeholder="" required/>
                    </div>
                    
                    <div class="form-group">
                      <label>URL</label>
                      <input type="text" class="form-control" name="m_url" placeholder="" value="" required/>
                    </div>
